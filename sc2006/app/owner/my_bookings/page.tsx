        ...
        <div className="min-h-screen bg-slate-50 font-sans pb-20">
                                ...
                                <div className="flex flex-col gap-3 w-full md:w-auto">
                                    ...
                                    {isLive && (
                                        <button
                                            ...
                                            className="flex-1 px-8 py-3.5 bg-red-600 text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-red-700 transition-all shadow-lg shadow-red-600/20 text-center flex items-center justify-center gap-2 active:scale-95"
                                        >
            ...
            {incidentContext && (
                <IncidentModal
                    ...
                    allowRefundRequest={incidentContext.allowRefundRequest}
                />
            )}
